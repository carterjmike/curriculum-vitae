...
\begin{etaremune}[leftmargin=1.75em, itemsep=0.5em]
  ...
  \item \underline{Afif N}$^\dagger$, McKay B$^\dagger$, Bacelar MFB, Cashaback JGA, \& textbf{Carter MJ}. Current accuracy is not always the best predictor of future accuracy: The consequences of dissociable bias and precision components. Poster presentation at the Annual Meeting of the \emph{Canadian Society for Psychomotor Learning \& Sport Psychology}; Kingston ON, Canada.
  
  \item \underline{Lalli M}$^\dagger$, Germain L$^\dagger$, McKay B$^\dagger$, \& textbf{Carter MJ}. (2023). The relationship between perceived competence and intrinsic motivation and motor skill retention: An exploratory analysis. Poster presentation at the Annual Meeting of the \emph{Canadian Society for Psychomotor Learning \& Sport Psychology}; Kingston ON, Canada.
