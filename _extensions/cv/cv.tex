...
$if(www)$\faIcon{home} & \href{https://$www$}{https://$www$}\\$endif$% %
...
$if(github)$\faIcon{github} & \href{https://github.com/$github$}{https://github.com/$github$}\\$endif$%
$if(linkedin)$\faIcon{linkedin} & \href{https://www.linkedin.com/in/$linkedin$}{https://linkedin.com/in/$linkedin$}\\$endif$%
...
$if(scholar)$\faIcon{graduation-cap} & \href{https://scholar.google.com/citations?user=$scholar$}{$scholar$}\\$endif$%
}
